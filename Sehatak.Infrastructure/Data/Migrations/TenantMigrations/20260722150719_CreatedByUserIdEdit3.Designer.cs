...
namespace Sehatak.Infrastructure.Data.Migrations.TenantMigrations
{
    ...
    [Migration("20260722150719_CreatedByUserIdEdit3")]
    partial class CreatedByUserIdEdit3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.General.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.General.EmailVerificationCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.TenantEntities.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.TenantEntities.AppointmentItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.TenantEntities.LabRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.TenantEntities.LabResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.TenantEntities.MedicalRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.TenantEntities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.TenantEntities.Waitlist", b =>
                {
                    ...
                    b.Property<DateTime?>("PreferredTimeSlot")
                        .HasColumnType("datetime(6)");
                    ...
                    b.HasIndex("PromotedAppointmentId");
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.General.Chat", b =>
                {
                    b.HasOne("Sehatak.Domain.Entities.TenantEntities.User", "Receiver")
                        .WithMany("receivedMessages")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Sehatak.Domain.Entities.TenantEntities.User", "Sender")
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.TenantEntities.AppointmentItem", b =>
                {
                    b.HasOne("Sehatak.Domain.Entities.TenantEntities.Appointment", "Appointment")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.TenantEntities.Doctor", b =>
                {
                    ...
                    b.HasOne("Sehatak.Domain.Entities.TenantEntities.User", "user")
                        .WithOne("doctor")
                        .HasForeignKey("Sehatak.Domain.Entities.TenantEntities.Doctor", "userId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.TenantEntities.DoctorRating", b =>
                {
                    b.HasOne("Sehatak.Domain.Entities.TenantEntities.Appointment", "Appointment")
                        .WithOne("Rating")
                        .HasForeignKey("Sehatak.Domain.Entities.TenantEntities.DoctorRating", "AppointmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.TenantEntities.FollowUp", b =>
                {
                    ...
                    b.HasOne("Sehatak.Domain.Entities.TenantEntities.Appointment", "OriginalAppointment")
                        .WithMany()
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.TenantEntities.LabResult", b =>
                {
                    b.HasOne("Sehatak.Domain.Entities.TenantEntities.LabRequest", "LabRequest")
                        .WithOne("LabResult")
                        .HasForeignKey("Sehatak.Domain.Entities.TenantEntities.LabResult", "LabRequestId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.HasOne("Sehatak.Domain.Entities.TenantEntities.Payment", "Payment")
                        .WithOne("LabResult")
                        .HasForeignKey("Sehatak.Domain.Entities.TenantEntities.LabResult", "PaymentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Sehatak.Domain.Entities.TenantEntities.User", "Technician")
                        .WithMany()
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.TenantEntities.Patient", b =>
                {
                    ...
                    b.HasOne("Sehatak.Domain.Entities.TenantEntities.User", "user")
                        .WithOne("patient")
                        .HasForeignKey("Sehatak.Domain.Entities.TenantEntities.Patient", "userId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Sehatak.Domain.Entities.TenantEntities.Waitlist", b =>
                {
                    ...
                    b.HasOne("Sehatak.Domain.Entities.TenantEntities.Appointment", "PromotedAppointment")
                        .WithMany()
                        .HasForeignKey("PromotedAppointmentId");
                    ...
                    b.Navigation("PromotedAppointment");
